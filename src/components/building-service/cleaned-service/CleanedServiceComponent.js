                        ...
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                <form>
                                    ...
                                    <div className="mb-3">
                                        <label htmlFor="times" className="form-label">Time per week</label>
                            ...
                            <div className="card-body">
                                <table className="table table-bordered text-center">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><b>Time per week:</b></td>
                                            <td>{this.state.currentCleanedService.timesPerWeek} times/week</td>
                                        </tr>
                                        <tr>
